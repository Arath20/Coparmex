...
def details():
    ...
    listbox.place(x=5, y=330, width=400, height=100)
    #-------------------------------------------------Contactos Area----------------------------------------------------------------------
    ...
    # listaData = cursor.execute("SELECT servicio FROM servicios")
    # customers = cursor.fetchall()
    
    mylistbox = Listbox(ventana)
    #mylistbox.bind('<<ListboxSelect>>',CurSelect)
    mylistbox.place(x=435, y=330, width=400, height=100)
    ...
    #Botones----------------------------------------
    btnReporte = Button(ventana, text="Generar Reporte de Servicios", bg="brown", fg="white")
    btnReporte.place(x=530, y=575)
